...
import { getRoutesApi } from '@/api/system/user';

export const DEFAULT = () => import('@/layout/default/index.vue');
  ...
  routes.forEach((item) => {
    ...
    if (component) {
      ...
      if (layoutFound) {
        ...
        item.component = dynamicImport(viewsModules, component as string) || DEFAULT;
      }
    } else if (name) {
